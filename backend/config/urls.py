...
urlpatterns = [
    ...
    path("api/vitals/", include("apps.inpatient.vitals_urls")),
    ...
    path("api/inpatient/", include("apps.inpatient.inpatient_urls")),
    path("api/nursing/", include("apps.inpatient.nursing_urls")),
    path("api/icu/", include("apps.inpatient.icu_urls")),
