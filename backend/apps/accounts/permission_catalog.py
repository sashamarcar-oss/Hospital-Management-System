...
EXTRA_PERMISSIONS = {
    ...
    "payments": ["receive_payment", "refund", "reverse"],
    ...
    "inpatient": ["assign_bed", "transfer", "release_bed", "reserve_bed", "manage_beds", "view_timeline"],
    "nursing": ["submit", "amend", "handover", "manage_fluid"],
    "icu": ["manage_thresholds", "record_fluid", "review"],
    "emergency": ["assign"],
...
ROLE_PERMISSIONS = {
    ...
    "receptionist": [
        ...
        "departments.view", "vitals.view", "admissions.view", "admissions.create",
        "admissions.discharge",
        "inpatient.view", "inpatient.assign_bed", "inpatient.transfer",
        "inpatient.release_bed", "inpatient.reserve_bed",
        "emergency.view", "emergency.create", "billing.view", "payments.view", "payments.create", "payments.receive_payment", "shifts.view",
    ...
    "doctor": [
        ...
        "admissions.discharge", "inpatient.view", "inpatient.view_timeline",
        "inpatient.transfer", "nursing.view", "icu.view", "icu.review",
    ...
    "nurse": [
        ...
        "vitals.update", "shifts.view",
        "queue.view", "admissions.view", "admissions.update",
        "admissions.assign_bed", "inpatient.view", "inpatient.view_timeline",
        "inpatient.assign_bed", "inpatient.transfer", "inpatient.release_bed",
        "inpatient.reserve_bed", "nursing.view", "nursing.create", "nursing.update",
        "nursing.submit",
        "nursing.amend", "nursing.handover", "nursing.manage_fluid", "icu.view",
        "emergency.view", "emergency.update", "consultations.view",
        "laboratory.view", "pharmacy.view", "documents.view", "documents.download", "notifications.view",
    ],
    "icu_nurse": [
        "dashboard.view", "patients.view", "appointments.view", "vitals.view", "vitals.create",
        "vitals.update", "shifts.view", "queue.view", "admissions.view",
        "inpatient.view", "inpatient.view_timeline", "nursing.view", "nursing.create",
        "nursing.update",
        "nursing.submit", "nursing.amend", "nursing.handover", "nursing.manage_fluid",
        "icu.view", "icu.create", "icu.update", "icu.record_fluid", "icu.review",
        "consultations.view", "laboratory.view", "pharmacy.view",
        "documents.view", "documents.download", "notifications.view",
    ],
    "lab_technician": [
